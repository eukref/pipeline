...
infile = open(sys.argv[1],"r")  ### tab delimited outfile of annotateclusters.py ==> "expandedclusters.txt"
lines = infile.readlines()
infile.close()
...
outfile = open(sys.argv[3],"w") ### cleared fastafile of "remove" sequences ==> "current_DB-cleared.fas"
